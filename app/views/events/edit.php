...
<body>
    <div class="container">
        <h1>Edit Event</h1>
        <p class="subtitle">Update your event details below</p>
        ...
        <form method="POST" action="/event/update/<?php echo $event['event_id']; ?>">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description"
                          placeholder="Tell your guests what this event is about..."><?php echo htmlspecialchars($event['description']); ?></textarea>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="max_guests" name="max_guests" min="1"
                           placeholder="e.g., 50"
                           value="<?php echo htmlspecialchars($event['max_guests']); ?>">
                ...
                <div class="form-group">
                    ...
                    <div class="help-text">Update event status</div>
                </div>
            </div>
